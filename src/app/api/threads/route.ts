...
async function fetchAllMedia(accessToken: string): Promise<MediaNode[]> {
  ...
  const until = Math.floor(new Date(yesterday.getFullYear(), yesterday.getMonth(), yesterday.getDate(), 23, 59, 59).getTime() / 1000);
